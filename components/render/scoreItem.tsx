  ...
  return (
    <div className={'relative'}>
      <div className={"rounded-lg flex bg-black/[.4] space-x-2  backdrop-blur-md"}>
        <Avatar src={scoreItem.leaderboard.coverImage} className={"rounded-md h-20 w-20"}/>
      ...
      <div className="absolute right-1 bottom-1 text-white flex text-xs space-x-2">
        {
          scoreItem.score.fullCombo &&
            <span className="from-red-300 to-red-300 bg-gradient-to-r bg-clip-text text-transparent">FC</span>
        }
      </div>
    </div>
